...
/*
*
* This file is a Node.js server use for debuging,
* and to route static files.
* It is useful to deal with Cross-domain problem
...
http.createServer(function (req, res) {
	...
	fs.exists(filePath, function(exists) {  
		...
		fs.readFile(filePath, "binary", function(err, file) {  
			...
			res.writeHead(200, {'Content-Type': MIMEType[ext] || 'text/html'});
